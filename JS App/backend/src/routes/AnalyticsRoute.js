...
anaylticsRouter.get('/get-payment/:wallet_id', authenticateJWT, authorizeRole(["admin"]), AnalyticsController.getAllCompletedPayments); // Calculation of the fare based on the destination and pickup
